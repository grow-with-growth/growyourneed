...
export const ContactDataCard: React.FC<ContactDataCardProps> = ({ title, children, className = '', footer }) => {
  return (
    <div 
      ...
      style={{ boxShadow: '0 0 20px rgba(20, 184, 166, 0.1), 0 0 8px rgba(20, 184, 166, 0.08)' }} // Teal glow
    >
      {title && (
        <h3 className="text-sm sm:text-base font-semibold text-teal-200 mb-2 sm:mb-3 pb-2 border-b border-slate-700/70 truncate">
            {title}
        </h3>
      )}
